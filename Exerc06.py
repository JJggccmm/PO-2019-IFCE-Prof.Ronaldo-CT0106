...
#CT0106 – Sexta contribuição da primeira etapa                                                             #
...
def desenhaGrafico(x,y,yde,file_name, label, label2,file_title, line_color, line_color2, mark, mark2,xl, yl):                                         #
...
def cria_Graficos(lista_entrada):                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   #
  ...
  desenhaGrafico(lista_entrada,tempos_orden,tempos_orden_decresc,"GraficoShellSort(Tamanho_Lista-X-Tempo_Ordenacoes)Lista_Aleatoria.png", "Tempo(Lista->Aleatoria)","Tempo(Lista->Decrescente)",'(Shell Sort-Lista Aleatória)Tamanho_Lista X Tempo_Ordenacoes','cyan','deeppink','s','^',"<Entradas/>","<Tempo-Saída/>")                                                      
  desenhaGrafico(lista_entrada, numer_iteracoes,numer_iteracoes_decresc,"GraficoShellSort(Tamanho_Lista-X-Numero_Iteracoes)Lista_Aleatoria.png","Numero_Iteracao(Lista->Aleatoria)","Numero_Iteracao(Lista->Decrescente)",'(Shell Sort-Lista Aleatória)Tamanho_Lista X Numero_Iteracoes','yellow','grey','d','o',"<Entradas/>","<'Swaps'(Num_Iterações)-Saída/>")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     #                                                                                                                                                                                                                                                                                                           
#################################################################################################################################################################################################################################################################################################################################################################}
